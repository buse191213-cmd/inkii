...
const NAV = [
  ...
  {
    href: "/admin/kollektionen",
    label: "Kollektionen",
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-6 9 6v11a1 1 0 01-1 1H4a1 1 0 01-1-1z"/><path d="M9 22V12h6v10"/></svg>',
  },
  {
