...
export default async function LeistungenPage() {
  ...
  const services = [
    { label: "Textildruck & Veredelung", desc: "Siebdruck, DTG, Stickerei, Transferdruck.", img: f1 },
    { label: "Team- & Sportswear", desc: "Trikots, Hoodies, Teamoutfits mit Logo.", img: f2 },
    { label: "Werbemittel & Merch", desc: "Tassen, Taschen, Powerbanks, Stifte u. v. m.", img: f3 },
    { label: "Arbeits- & Berufskleidung", desc: "Robuste Workwear, individuell bedruckt.", img: f4 },
    { label: "Eigene Onlineshops", desc: "Mitarbeiter- und Vereinsshops aus einer Hand.", img: f5 },
    { label: "Nachhaltige Produktion", desc: "Eco-zertifizierte Lieferanten und faire Partner.", img: f6 },
  ];
