...
export type StatusMailParams = {
  ...
  bannerIcon: string;      // Icon-Schlüssel: payment | production | package | delivered | done | cancelled
...
/**
 * Liefert ein sauberes, weißes Linien-Icon (Stil „rounded lineal") als inline
 * SVG für das Banner. Wirkt hochwertiger als Emojis und ist markenkonform.
 * Fallback: falls ein Client kein inline-SVG rendert, bleibt der Banner-Text
