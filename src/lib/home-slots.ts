...
export const HOME_SLOTS: HomeSlot[] = [
  ...
  { slot: "feat-1", label: "Leistung 1 — Professionelle Textilveredelung", group: "feature" },
  { slot: "feat-2", label: "Leistung 2 — Firmen- und Berufsbekleidung", group: "feature" },
  { slot: "feat-3", label: "Leistung 3 — Team- & Sportbekleidung", group: "feature" },
  { slot: "feat-4", label: "Leistung 4 — Hochwertige Werbemittel", group: "feature" },
  { slot: "feat-5", label: "Leistung 5 — INKII Works Shop", group: "feature" },
  { slot: "feat-6", label: "Leistung 6 — Webdesign & digitale Lösungen", group: "feature" },
  { slot: "feat-7", label: "Leistung 7 — Onlineshops für Unternehmen", group: "feature" },
  { slot: "feat-8", label: "Leistung 8 — Ganzheitliche Marketinglösungen", group: "feature" },
